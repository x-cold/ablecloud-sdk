(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("ac-node-sdk", [], factory);
	else if(typeof exports === 'object')
		exports["ac-node-sdk"] = factory();
	else
		root["ac-node-sdk"] = factory();
})(this, function() {
...
let crypto = __webpack_require__(49)

module.exports = {
    signToken (developerId, majorDomain, sk, method) {
...
let ACClient = __webpack_require__(18)
let ACConfig = __webpack_require__(50)
let ACHttpRequest = __webpack_require__(52)
...
module.exports = {
     ...
     *
     */
    init(developerId, majorDomain, ak, sk, router) {
...
let ACSign = __webpack_require__(15)
...
function buildHeaders(method, isAnoymous, config) {
    ...
    if (isAnoymous) {
        ...
        return ACSign.signToken(config.developerId, config.majorDomain, config.sk, method).then(signed => {
